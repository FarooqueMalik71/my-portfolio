...
function Navbar() {
  ...
  return (
    <div className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-secondary/80 backdrop-blur-md shadow-lg' : 'bg-transparent'
      }`}>
      <div className="container px-6 py-4 mx-auto">
        ...
        {/* Mobile Menu */}
        <div className={`md:hidden overflow-hidden transition-all duration-300 ${menuOpen ? 'max-h-96 opacity-100 visible' : 'max-h-0 opacity-0 invisible'
          }`}>
